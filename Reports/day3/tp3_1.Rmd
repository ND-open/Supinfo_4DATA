...
3.  At the console prompt, type librairy() to view all loaded packages. A list of packages will appear in a window above the console window.
...
17.  Install MongoDB. To start the MongoDB server, double-click the mongodb server icon on your desktop.
